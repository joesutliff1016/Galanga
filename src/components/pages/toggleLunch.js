...
export default class ToggleLunch extends Component {
  ...
  render() {
    return (
      ...
      {this.state.on && (
        ...
        <Link className="urhere" to="/lunchPage">Lunch</Link>
        <Link to="/dinnerPage">Dinner</Link>
        <Link to="/contactPage">Contact</Link>
        <Link onClick={this.toggle} to="/lunchPage">What is Galanga?</Link>
        </div>
      )
    }
  }
